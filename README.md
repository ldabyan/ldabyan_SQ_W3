...
**Controls:**
- P1: A/D to move, F to attack, G to block
- P2: Arrow keys to move, K to attack, L to block

Press ENTER to start. First to land 3 hits wins. Press ENTER again to rematch.
